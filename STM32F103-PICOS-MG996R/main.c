...
написать команду "led 1" или "led = 0". Для управления сервоприводом можно 
написать "servo ...".
...
#define VERSION 33 // Версия данной прошивки - 3.3
...
#include "Tasks/servo_drive_switch.h" // Изменение положения сервопривода
...
var_table_t var_table[] = {
  ...
  {"servo", "Angle of rotation: 0..180", TYPE_UINT16_T, &servo_drive_switch}
};
...
int main(void) {
  ...
  // Преобразование целочисленного 00033 в строку "3.3"
  Uint16ToStr(fm_version * 100, version); // Перевод uint16_t в str
  version[3] = '\0'; // "03300" -> "033"
  version[0] = version[1]; // "033" -> "333"
  version[1] = '.'; // "333" -> "3.3"
...
// =============================== ГЛАВНЫЙ ЦИКЛ ===============================
  while (1) {
    ...
    #include "Tasks/servo_drive_switch.c" // Изменение положения сервопривода
  }
} // КОНЕЦ